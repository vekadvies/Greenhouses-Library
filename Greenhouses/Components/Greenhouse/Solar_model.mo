...
equation
  ...
  (tau_ML_covPAR,rho_ML_covPAR) = Functions.MultiLayer_TauRho(
    tau_RfPAR,
    tau_thScrPAR,
    rho_RfPAR,
    rho_thScrPAR);
  (tau_ML_covNIR,rho_ML_covNIR) = Functions.MultiLayer_TauRho(
    tau_RfNIR,
    tau_thScrNIR,
    rho_RfNIR,
    rho_thScrNIR);
  ...
  (tau_CF_NIR,rho_CF_NIR) = Functions.MultiLayer_TauRho(
    exp(-K_NIR*LAI),
    1 - rho_FlrNIR,
  ...
  (tau_CCF_NIR,rho_CCF_NIR) = Functions.MultiLayer_TauRho(
    tau_covNIR,
    tau_CF_NIR,
    rho_covNIR,
    rho_CF_NIR);
